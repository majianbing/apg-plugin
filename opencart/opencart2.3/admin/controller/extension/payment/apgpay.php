...
class ControllerExtensionPaymentApgpay extends Controller {
    ...
    public function index() {
        $this->load->language('extension/payment/apgpay');
        ...
        $data['action'] = $this->url->link('extension/payment/apgpay', 'token=' . $this->session->data['token'], true);
        ...
        $data['breadcrumbs'] = array(
            ...
            array(
                ...
                'href' => $this->url->link('extension/payment/apgpay', 'token=' . $this->session->data['token'], 'SSL'),
            )
        );
...
//        $data['return_url'] = HTTPS_CATALOG . 'index.php?route=payment/apgpay/paymentreturn';
        ...
        $this->response->setOutput($this->load->view('extension/payment/apgpay', $data));
    }

	private function validate() {
		if (!$this->user->hasPermission('modify', 'extension/payment/apgpay')) {
