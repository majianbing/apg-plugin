      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-apgpay" class="form-horizontal">
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="entry-apgpay_title"><?php echo $entry_apgpay_title; ?></label>
            <div class="col-sm-10">
              <input type="text" name="apgpay_title" value="<?php echo $apgpay_title; ?>" placeholder="<?php echo $entry_apgpay_title; ?>" id="entry-apgpay_title" class="form-control"/>
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="entry-apgpay_merchant_id"><?php echo $entry_apgpay_merchant_id; ?></label>
            <div class="col-sm-10">
              <input type="text" name="apgpay_merchant_id" value="<?php echo $apgpay_merchant_id; ?>" placeholder="<?php echo $entry_apgpay_merchant_id; ?>" id="entry-apgpay_merchant_id" class="form-control"/>
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="entry-apgpay_private_key"><?php echo $entry_apgpay_private_key; ?></label>
            <div class="col-sm-10">
              <input type="text" name="apgpay_private_key" value="<?php echo $apgpay_private_key; ?>" placeholder="<?php echo $entry_apgpay_private_key; ?>" id="entry-apgpay_private_key" class="form-control"/>
